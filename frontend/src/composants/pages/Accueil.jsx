        ...
        <main className="Accueil">
            <div id="container">
                ...
                <div id="divPresentationProjet">
                    ...
                    <p>
                        Sur ce site, j'utilise l'
                        <a href="https://www.themoviedb.org" className="lien">
                            API TMDB
                        </a>{" "}
                        pour récupérer différentes informations sur les films (affiche, boîte de production, date de sortie , ...)
                    </p>
                </div>
            </div>
        </main>
